...
// Set JavaScript objects as variables (v0.10.1+)
...
class WangInterpreter {
  ...
  setVariable(name: string, value: any): void;  // v0.10.1+
}
```

#### Setting Variables

The `setVariable()` method (v0.10.1+) allows you to inject JavaScript objects and values directly into Wang's global scope:
