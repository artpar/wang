...
exports.WangError = WangError;
class ModuleNotFoundError extends WangError {
...
class CircularDependencyError extends WangError {
    constructor(cycle) {
...
class TypeMismatchError extends WangError {
...
class UndefinedVariableError extends WangError {
...
class FunctionNotFoundError extends WangError {
