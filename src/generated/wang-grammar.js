...
(function () {
  ...
  var grammar = {
    ...
    ParserRules: [
      ...
      {
        name: 'asIdentifier',
        symbols: [{ literal: 'as' }, lexer.has('identifier') ? { type: 'identifier' } : identifier],
        postprocess: (d) => d[1].value,
      },
      {
      ...
      {
        name: 'catchParam',
        symbols: [{ literal: '(' }, 'BindingPattern', { literal: ')' }],
        postprocess: (d) => d[1],
      },
      {
        name: 'functionName',
      ...
      { name: 'Statement', symbols: ['Block'], postprocess: id },
      {
        ...
        postprocess: (d) => ({ type: 'ImportDeclaration', specifiers: d[1], source: d[3].value }),
      },
      {
        name: 'ImportStatement',
        symbols: [{ literal: 'import' }, lexer.has('string') ? { type: 'string' } : string],
        postprocess: (d) => ({ type: 'ImportDeclaration', specifiers: [], source: d[1].value }),
      },
      {
        name: 'ImportSpecifiers',
        symbols: [{ literal: '{' }, 'ImportSpecifierList', { literal: '}' }],
        postprocess: (d) => d[1],
      },
      {
        name: 'ImportSpecifiers',
        ...
        postprocess: (d) => [{ type: 'ImportNamespaceSpecifier', local: d[2].value }],
      },
      { name: 'ImportSpecifierList', symbols: ['ImportSpecifier'], postprocess: (d) => [d[0]] },
      {
        name: 'ImportSpecifierList',
        symbols: ['ImportSpecifierList', { literal: ',' }, 'ImportSpecifier'],
        postprocess: (d) => [...d[0], d[2]],
      },
      { name: 'ImportSpecifier$ebnf$1', symbols: ['asIdentifier'], postprocess: id },
      {
        name: 'ImportSpecifier$ebnf$1',
        symbols: [],
      ...
      },
      {
        ...
        symbols: [{ literal: 'export' }, 'VariableDeclaration'],
        postprocess: (d) => ({ type: 'ExportNamedDeclaration', declaration: d[1] }),
      },
      {
        name: 'ExportStatement',
        symbols: [{ literal: 'export' }, 'FunctionDeclaration'],
        postprocess: (d) => ({ type: 'ExportNamedDeclaration', declaration: d[1] }),
      },
      {
        name: 'ExportStatement',
        symbols: [{ literal: 'export' }, 'ClassDeclaration'],
        postprocess: (d) => ({ type: 'ExportNamedDeclaration', declaration: d[1] }),
      },
      {
        name: 'ExportStatement',
        symbols: [{ literal: 'export' }, { literal: '{' }, 'ExportSpecifierList', { literal: '}' }],
        postprocess: (d) => ({ type: 'ExportNamedDeclaration', specifiers: d[2] }),
      },
      { name: 'ExportSpecifierList', symbols: ['ExportSpecifier'], postprocess: (d) => [d[0]] },
      {
        name: 'ExportSpecifierList',
        symbols: ['ExportSpecifierList', { literal: ',' }, 'ExportSpecifier'],
        postprocess: (d) => [...d[0], d[2]],
      },
      { name: 'ExportSpecifier$ebnf$1', symbols: ['asIdentifier'], postprocess: id },
      {
        name: 'ExportSpecifier$ebnf$1',
        symbols: [],
        postprocess: function (d) {
          return null;
        },
      ...
      { name: 'VariableDeclaration$subexpression$1', symbols: [{ literal: 'var' }] },
      {
        ...
        symbols: ['VariableDeclaration$subexpression$1', 'VariableDeclaratorList'],
        postprocess: (d) => ({
      ...
      },
      {
        ...
        symbols: ['VariableDeclarator'],
        postprocess: (d) => [d[0]],
      },
      {
        name: 'VariableDeclaratorList',
        symbols: ['VariableDeclaratorList', { literal: ',' }, 'VariableDeclarator'],
        postprocess: (d) => [...d[0], d[2]],
      },
      { name: 'VariableDeclarator$ebnf$1', symbols: ['defaultAssignment'], postprocess: id },
      {
        name: 'VariableDeclarator$ebnf$1',
        symbols: [],
        postprocess: function (d) {
          return null;
        },
      },
      {
        ...
        symbols: ['BindingPattern', 'VariableDeclarator$ebnf$1'],
        postprocess: (d) => ({ type: 'VariableDeclarator', id: d[0], init: d[1] ? d[1] : null }),
      },
      {
        name: 'BindingPattern',
        symbols: [lexer.has('identifier') ? { type: 'identifier' } : identifier],
        postprocess: (d) => ({ type: 'Identifier', name: d[0].value }),
      },
      { name: 'BindingPattern', symbols: ['ObjectPattern'], postprocess: id },
      { name: 'BindingPattern', symbols: ['ArrayPattern'], postprocess: id },
      {
        name: 'ObjectPattern',
        symbols: [{ literal: '{' }, 'ObjectPatternProperties', { literal: '}' }],
        postprocess: (d) => ({ type: 'ObjectPattern', properties: d[1] }),
      },
      { name: 'ObjectPatternProperties', symbols: [], postprocess: () => [] },
      {
        name: 'ObjectPatternProperties',
        symbols: ['ObjectPatternProperty'],
        postprocess: (d) => [d[0]],
      },
      {
        name: 'ObjectPatternProperties',
        symbols: ['ObjectPatternProperties', { literal: ',' }, 'ObjectPatternProperty'],
        postprocess: (d) => [...d[0], d[2]],
      },
      {
        name: 'ObjectPatternProperty',
        symbols: [lexer.has('identifier') ? { type: 'identifier' } : identifier],
        postprocess: (d) => ({
          type: 'Property',
          key: d[0].value,
      ...
      },
      {
        ...
        postprocess: (d) => ({ type: 'Property', key: d[0].value, value: d[2], shorthand: false }),
      },
      {
        name: 'ObjectPatternProperty',
        symbols: [
        ...
        postprocess: (d) => ({ type: 'RestElement', argument: d[1].value }),
      },
      {
        name: 'ArrayPattern',
        symbols: [{ literal: '[' }, 'ArrayPatternElements', { literal: ']' }],
        postprocess: (d) => ({ type: 'ArrayPattern', elements: d[1] }),
      },
      { name: 'ArrayPatternElements', symbols: [], postprocess: () => [] },
      {
        name: 'ArrayPatternElements',
        symbols: ['ArrayPatternElement'],
        postprocess: (d) => [d[0]],
      },
      {
        name: 'ArrayPatternElements',
        symbols: ['ArrayPatternElements', { literal: ',' }, 'ArrayPatternElement'],
        postprocess: (d) => [...d[0], d[2]],
      },
      { name: 'ArrayPatternElement', symbols: ['BindingPattern'], postprocess: id },
      {
        name: 'ArrayPatternElement',
        symbols: [
          { literal: '...' },
          lexer.has('identifier') ? { type: 'identifier' } : identifier,
        ],
      ...
      {
        name: 'ParameterList',
        symbols: ['ParameterList', { literal: ',' }, 'Parameter'],
        postprocess: (d) => [...d[0], d[2]],
      },
      { name: 'Parameter', symbols: ['BindingPattern'], postprocess: id },
      {
        name: 'Parameter',
        symbols: ['BindingPattern', { literal: '=' }, 'AssignmentExpression'],
        postprocess: (d) => ({ type: 'AssignmentPattern', left: d[0], right: d[2] }),
      },
      {
        name: 'Parameter',
        symbols: [{ literal: '...' }, 'BindingPattern'],
        postprocess: (d) => ({ type: 'RestElement', argument: d[1] }),
      },
      { name: 'ClassDeclaration$ebnf$1', symbols: ['extendsClause'], postprocess: id },
      {
        name: 'ClassDeclaration$ebnf$1',
        symbols: [],
        postprocess: function (d) {
          return null;
        },
      ...
      {
        name: 'ClassBody',
        symbols: [{ literal: '{' }, 'ClassMembers', { literal: '}' }],
        postprocess: (d) => ({ type: 'ClassBody', body: d[1] }),
      },
      { name: 'ClassMembers', symbols: [], postprocess: () => [] },
      {
        name: 'ClassMembers',
        symbols: ['ClassMembers', 'ClassMember'],
        postprocess: (d) => (d[1] ? [...d[0], d[1]] : d[0]),
      },
      ...
      {
        name: 'MethodDefinition$ebnf$1',
        symbols: ['MethodDefinition$ebnf$1', 'staticAsyncGetSet'],
      ...
      },
      {
        ...
        postprocess: (d) => ({
          ...
          kind:
            d[0].find((k) => k && (k[0].value === 'get' || k[0].value === 'set'))?.[0].value ||
            'method',
      ...
      {
        name: 'PropertyDefinition$ebnf$1',
        symbols: [],
        postprocess: function (d) {
          return null;
        },
      ...
      {
        name: 'PropertyDefinition$ebnf$2',
        symbols: [],
        postprocess: function (d) {
          return null;
        },
      },
      {
        ...
        symbols: [
          'PropertyDefinition$ebnf$1',
          lexer.has('identifier') ? { type: 'identifier' } : identifier,
          'PropertyDefinition$ebnf$2',
          'semicolon',
        ],
        postprocess: (d) => ({
      ...
      { name: 'SwitchCases', symbols: [], postprocess: () => [] },
      { name: 'SwitchCases', symbols: ['SwitchCase'], postprocess: (d) => [d[0]] },
      {
        name: 'SwitchCases',
        symbols: ['SwitchCases', 'SwitchCase'],
        postprocess: (d) => [...d[0], d[1]],
      },
      {
        name: 'SwitchCase',
        symbols: [{ literal: 'case' }, 'Expression', { literal: ':' }, 'Statements'],
        postprocess: (d) => ({
          type: 'SwitchCase',
          test: d[1],
          consequent: d[3],
      ...
      {
        name: 'SwitchCase',
        symbols: [{ literal: 'default' }, { literal: ':' }, 'Statements'],
        postprocess: (d) => ({
          type: 'SwitchCase',
          test: null,
          consequent: d[2],
      ...
      {
        name: 'BreakStatement',
        symbols: [{ literal: 'break' }, { literal: ';' }],
        postprocess: (d) => ({ type: 'BreakStatement', label: null }),
      },
      {
        name: 'BreakStatement',
        symbols: [
        ...
        postprocess: (d) => ({ type: 'BreakStatement', label: d[1].value }),
      },
      {
        name: 'ContinueStatement',
        symbols: [{ literal: 'continue' }, { literal: ';' }],
        postprocess: (d) => ({ type: 'ContinueStatement', label: null }),
      },
      {
        name: 'ContinueStatement',
        symbols: [
        ...
        postprocess: (d) => ({ type: 'ContinueStatement', label: d[1].value }),
      },
      {
      ...
      {
        name: 'TryStatement',
        symbols: [{ literal: 'try' }, 'Block', 'TryStatement$ebnf$1', 'TryStatement$ebnf$2'],
        postprocess: (d) => ({
          type: 'TryStatement',
          block: d[1],
          handler: d[2],
      ...
      {
        name: 'CatchClause',
        symbols: [{ literal: 'catch' }, 'CatchClause$ebnf$1', 'Block'],
        postprocess: (d) => ({
          type: 'CatchClause',
          param: d[1] ? d[1] : null,
          body: d[2],
      ...
      {
        name: 'FinallyClause',
        symbols: [{ literal: 'finally' }, 'Block'],
        postprocess: (d) => d[1],
      },
      {
        name: 'ThrowStatement',
        symbols: [{ literal: 'throw' }, 'Expression'],
        postprocess: (d) => ({ type: 'ThrowStatement', argument: d[1] }),
      },
      {
        name: 'ReturnStatement',
        symbols: [{ literal: 'return' }, 'Expression'],
        postprocess: (d) => ({ type: 'ReturnStatement', argument: d[1] }),
      },
      {
        name: 'ReturnStatement',
        symbols: [{ literal: 'return' }],
        postprocess: (d) => ({ type: 'ReturnStatement', argument: null }),
      },
      {
        name: 'ExpressionStatement',
        symbols: ['PipelineExpressionNoFunction'],
        postprocess: (d) => ({ type: 'ExpressionStatement', expression: d[0] }),
      },
      {
        name: 'PipelineExpressionNoFunction',
        symbols: ['AssignmentExpressionNoFunction'],
        postprocess: id,
      },
      {
        name: 'PipelineExpressionNoFunction',
        symbols: ['PipelineExpressionNoFunction', 'pipelineOp', 'AssignmentExpression'],
        postprocess: (d) => buildPipeline(d[0], d[1], d[2]),
      },
      {
        name: 'pipelineOp',
        symbols: [lexer.has('pipeline') ? { type: 'pipeline' } : pipeline],
        postprocess: (d) => d[0].value,
      },
      {
        name: 'pipelineOp',
        symbols: [lexer.has('arrow') ? { type: 'arrow' } : arrow],
        postprocess: (d) => d[0].value,
      },
      {
        name: 'AssignmentExpressionNoFunction',
        symbols: ['ConditionalExpressionNoFunction'],
        postprocess: id,
      },
      ...
      { name: 'AssignmentExpressionNoFunction$subexpression$1', symbols: [{ literal: '/=' }] },
      {
        ...
        symbols: [
          ...
          'AssignmentExpressionNoFunction$subexpression$1',
      ...
      {
        name: 'ConditionalExpressionNoFunction',
        symbols: ['LogicalOrExpressionNoFunction'],
        postprocess: id,
      },
      {
        name: 'ConditionalExpressionNoFunction',
      ...
      {
        name: 'LogicalOrExpressionNoFunction',
        symbols: ['LogicalAndExpressionNoFunction'],
        postprocess: id,
      },
      ...
      { name: 'LogicalOrExpressionNoFunction$subexpression$1', symbols: [{ literal: '??' }] },
      {
        ...
        symbols: [
          'LogicalOrExpressionNoFunction',
          'LogicalOrExpressionNoFunction$subexpression$1',
          'LogicalAndExpression',
        ],
        postprocess: (d) => buildBinaryOp(d[0], d[1][0].value, d[2]),
      },
      {
        name: 'LogicalAndExpressionNoFunction',
        symbols: ['EqualityExpressionNoFunction'],
        postprocess: id,
      },
      {
        name: 'LogicalAndExpressionNoFunction',
        symbols: ['LogicalAndExpressionNoFunction', { literal: '&&' }, 'EqualityExpression'],
        postprocess: (d) => buildBinaryOp(d[0], d[1].value, d[2]),
      },
      {
        name: 'EqualityExpressionNoFunction',
        symbols: ['RelationalExpressionNoFunction'],
        postprocess: id,
      },
      ...
      { name: 'EqualityExpressionNoFunction$subexpression$1', symbols: [{ literal: '!==' }] },
      {
        ...
        symbols: [
          ...
          'EqualityExpressionNoFunction$subexpression$1',
          'RelationalExpression',
        ],
        postprocess: (d) => buildBinaryOp(d[0], d[1][0].value, d[2]),
      },
      {
        name: 'RelationalExpressionNoFunction',
        symbols: ['AdditiveExpressionNoFunction'],
        postprocess: id,
      },
      ...
      { name: 'RelationalExpressionNoFunction$subexpression$1', symbols: [{ literal: '>=' }] },
      {
        ...
        symbols: [
          ...
          'RelationalExpressionNoFunction$subexpression$1',
          'AdditiveExpression',
        ],
        postprocess: (d) => buildBinaryOp(d[0], d[1][0].value, d[2]),
      },
      {
        name: 'AdditiveExpressionNoFunction',
        symbols: ['MultiplicativeExpressionNoFunction'],
        postprocess: id,
      },
      ...
      { name: 'AdditiveExpressionNoFunction$subexpression$1', symbols: [{ literal: '-' }] },
      {
        ...
        symbols: [
          ...
          'AdditiveExpressionNoFunction$subexpression$1',
          'MultiplicativeExpression',
        ],
        postprocess: (d) => buildBinaryOp(d[0], d[1][0].value, d[2]),
      },
      {
        name: 'MultiplicativeExpressionNoFunction',
        symbols: ['ExponentiationExpressionNoFunction'],
        postprocess: id,
      },
      ...
      { name: 'MultiplicativeExpressionNoFunction$subexpression$1', symbols: [{ literal: '%' }] },
      {
        ...
        symbols: [
          ...
          'MultiplicativeExpressionNoFunction$subexpression$1',
          'ExponentiationExpression',
        ],
        postprocess: (d) => buildBinaryOp(d[0], d[1][0].value, d[2]),
      },
      {
        name: 'ExponentiationExpressionNoFunction',
        symbols: ['UnaryExpressionNoFunction'],
        postprocess: id,
      },
      {
        name: 'ExponentiationExpressionNoFunction',
        symbols: ['UnaryExpressionNoFunction', { literal: '**' }, 'ExponentiationExpression'],
        postprocess: (d) => buildBinaryOp(d[0], d[1].value, d[2]),
      },
      {
        name: 'UnaryExpressionNoFunction',
        symbols: ['PostfixExpressionNoFunction'],
        postprocess: id,
      },
      ...
      {
        name: 'UnaryExpressionNoFunction',
        symbols: ['UnaryExpressionNoFunction$subexpression$1', 'UnaryExpression'],
        postprocess: (d) => buildUnaryOp(d[0][0].value, d[1]),
      },
      {
        name: 'PostfixExpressionNoFunction',
        symbols: ['MemberExpressionNoFunction'],
        postprocess: id,
      },
      ...
      {
        name: 'PostfixExpressionNoFunction',
        symbols: ['MemberExpressionNoFunction', 'PostfixExpressionNoFunction$subexpression$1'],
        postprocess: (d) => ({
      ...
      {
        name: 'MemberExpressionNoFunction',
        symbols: ['CallExpressionNoFunction'],
        postprocess: id,
      },
      { name: 'MemberExpressionNoFunction$ebnf$1', symbols: ['Arguments'], postprocess: id },
      {
        name: 'MemberExpressionNoFunction$ebnf$1',
        symbols: [],
        postprocess: function (d) {
          return null;
        },
      },
      {
        ...
        symbols: [
          ...
          'MemberExpressionNoFunction$ebnf$1',
        ],
        postprocess: (d) => ({
          type: 'NewExpression',
          callee: d[1],
      ...
      {
        name: 'CallExpressionNoFunction',
        symbols: ['PrimaryExpressionNoFunction'],
        postprocess: id,
      },
      {
        name: 'CallExpressionNoFunction',
      ...
      {
        name: 'CallExpressionNoFunction',
        symbols: ['CallExpressionNoFunction', { literal: '[' }, 'Expression', { literal: ']' }],
        postprocess: (d) => ({
          type: 'MemberExpression',
          object: d[0],
          property: d[2],
      ...
      {
        name: 'CallExpressionNoFunction',
        symbols: ['CallExpressionNoFunction', 'Arguments'],
        postprocess: (d) => ({
          type: 'CallExpression',
          callee: d[0],
          arguments: d[1],
      ...
      {
        name: 'PrimaryExpressionNoFunction',
        symbols: [{ literal: 'this' }],
        postprocess: (d) => ({ type: 'ThisExpression' }),
      },
      {
        name: 'PrimaryExpressionNoFunction',
        symbols: [{ literal: 'super' }],
        postprocess: (d) => ({ type: 'Super' }),
      },
      {
        name: 'PrimaryExpressionNoFunction',
        symbols: [lexer.has('identifier') ? { type: 'identifier' } : identifier],
      ...
      },
      {
        name: 'PrimaryExpressionNoFunction',
        symbols: [{ literal: '_' }],
        postprocess: (d) => ({ type: 'Identifier', name: '_' }),
      },
      ...
      {
        name: 'PrimaryExpressionNoFunction',
        symbols: ['ObjectLiteralNoFunction'],
        postprocess: id,
      },
      {
        name: 'PrimaryExpressionNoFunction',
        symbols: [{ literal: '(' }, 'PipelineExpressionNoFunction', { literal: ')' }],
        postprocess: (d) => d[1],
      },
      ...
      { name: 'PipelineExpression', symbols: ['AssignmentExpression'], postprocess: id },
      {
        ...
        symbols: ['PipelineExpression', 'pipelineOp', 'AssignmentExpression'],
        postprocess: (d) => buildPipeline(d[0], d[1], d[2]),
      },
      ...
      { name: 'AssignmentExpression$subexpression$1', symbols: [{ literal: '/=' }] },
      {
        ...
        symbols: [
          'ConditionalExpression',
          'AssignmentExpression$subexpression$1',
          'AssignmentExpression',
        ],
        postprocess: (d) => ({
          type: 'AssignmentExpression',
      ...
      { name: 'LogicalOrExpression$subexpression$1', symbols: [{ literal: '??' }] },
      {
        ...
        symbols: [
          'LogicalOrExpression',
          'LogicalOrExpression$subexpression$1',
          'LogicalAndExpression',
        ],
        postprocess: (d) => buildBinaryOp(d[0], d[1][0].value, d[2]),
      },
      { name: 'LogicalAndExpression', symbols: ['EqualityExpression'], postprocess: id },
      {
        ...
        symbols: ['LogicalAndExpression', { literal: '&&' }, 'EqualityExpression'],
        postprocess: (d) => buildBinaryOp(d[0], d[1].value, d[2]),
      },
      ...
      { name: 'EqualityExpression$subexpression$1', symbols: [{ literal: '!==' }] },
      {
        ...
        symbols: [
          'EqualityExpression',
          'EqualityExpression$subexpression$1',
          'RelationalExpression',
        ],
        postprocess: (d) => buildBinaryOp(d[0], d[1][0].value, d[2]),
      },
      ...
      { name: 'RelationalExpression$subexpression$1', symbols: [{ literal: '>=' }] },
      {
        ...
        symbols: [
          'RelationalExpression',
          'RelationalExpression$subexpression$1',
          'AdditiveExpression',
        ],
        postprocess: (d) => buildBinaryOp(d[0], d[1][0].value, d[2]),
      },
      ...
      { name: 'AdditiveExpression$subexpression$1', symbols: [{ literal: '-' }] },
      {
        ...
        symbols: [
          'AdditiveExpression',
          'AdditiveExpression$subexpression$1',
          'MultiplicativeExpression',
        ],
        postprocess: (d) => buildBinaryOp(d[0], d[1][0].value, d[2]),
      },
      ...
      { name: 'MultiplicativeExpression$subexpression$1', symbols: [{ literal: '%' }] },
      {
        ...
        symbols: [
          'MultiplicativeExpression',
          'MultiplicativeExpression$subexpression$1',
          'ExponentiationExpression',
        ],
        postprocess: (d) => buildBinaryOp(d[0], d[1][0].value, d[2]),
      },
      { name: 'ExponentiationExpression', symbols: ['UnaryExpression'], postprocess: id },
      {
        ...
        symbols: ['UnaryExpression', { literal: '**' }, 'ExponentiationExpression'],
        postprocess: (d) => buildBinaryOp(d[0], d[1].value, d[2]),
      },
      ...
      { name: 'UnaryExpression$subexpression$1', symbols: [{ literal: 'await' }] },
      {
        ...
        symbols: ['UnaryExpression$subexpression$1', 'UnaryExpression'],
        postprocess: (d) => buildUnaryOp(d[0][0].value, d[1]),
      },
      ...
      { name: 'PostfixExpression$subexpression$1', symbols: [{ literal: '--' }] },
      {
        ...
        symbols: ['MemberExpression', 'PostfixExpression$subexpression$1'],
        postprocess: (d) => ({
          type: 'UpdateExpression',
          operator: d[1][0].value,
          argument: d[0],
      ...
      },
      {
        ...
        symbols: [
          { literal: 'new' },
          'MemberExpression$subexpression$1',
          'MemberExpression$ebnf$1',
        ],
        postprocess: (d) => ({
          type: 'NewExpression',
          callee: d[1][0],
      ...
      {
        name: 'MemberAccessExpression',
        symbols: ['MemberAccessExpression', { literal: '[' }, 'Expression', { literal: ']' }],
        postprocess: (d) => ({
          type: 'MemberExpression',
          object: d[0],
          property: d[2],
      ...
      {
        name: 'CallExpression',
        symbols: ['CallExpression', { literal: '[' }, 'Expression', { literal: ']' }],
        postprocess: (d) => ({
          type: 'MemberExpression',
          object: d[0],
          property: d[2],
      ...
      {
        name: 'CallExpression',
        symbols: ['CallExpression', 'Arguments'],
        postprocess: (d) => ({
          type: 'CallExpression',
          callee: d[0],
          arguments: d[1],
      ...
      {
        name: 'Arguments',
        symbols: [{ literal: '(' }, 'ArgumentList', { literal: ')' }],
        postprocess: (d) => d[1],
      },
      ...
      {
        name: 'ArgumentList',
        symbols: ['ArgumentList', { literal: ',' }, 'AssignmentExpression'],
        postprocess: (d) => [...d[0], d[2]],
      },
      {
        name: 'ArgumentList',
        symbols: [{ literal: '...' }, 'AssignmentExpression'],
        postprocess: (d) => [{ type: 'SpreadElement', argument: d[1] }],
      },
      {
      ...
      },
      {
        ...
        postprocess: (d) => ({ type: 'Literal', value: parseFloat(d[0].value), raw: d[0].value }),
      },
      {
        name: 'Literal',
        symbols: [lexer.has('string') ? { type: 'string' } : string],
        postprocess: (d) => ({ type: 'Literal', value: d[0].value, raw: d[0].text }),
      },
      {
        name: 'Literal',
        symbols: [lexer.has('templateLiteral') ? { type: 'templateLiteral' } : templateLiteral],
        postprocess: (d) => ({ type: 'TemplateLiteral', value: d[0].value, raw: d[0].text }),
      },
      {
        name: 'Literal',
        symbols: [{ literal: 'true' }],
        postprocess: (d) => ({ type: 'Literal', value: true, raw: 'true' }),
      },
      {
        name: 'Literal',
        symbols: [{ literal: 'false' }],
        postprocess: (d) => ({ type: 'Literal', value: false, raw: 'false' }),
      },
      {
        name: 'Literal',
        symbols: [{ literal: 'null' }],
        postprocess: (d) => ({ type: 'Literal', value: null, raw: 'null' }),
      },
      {
        name: 'Literal',
        symbols: [{ literal: 'undefined' }],
        postprocess: (d) => ({ type: 'Literal', value: undefined, raw: 'undefined' }),
      },
      {
        name: 'ArrayLiteral',
        symbols: [{ literal: '[' }, { literal: ']' }],
        postprocess: (d) => ({ type: 'ArrayExpression', elements: [] }),
      },
      {
        name: 'ArrayLiteral',
        symbols: [{ literal: '[' }, 'ArrayElementList', { literal: ']' }],
        postprocess: (d) => ({ type: 'ArrayExpression', elements: d[1] }),
      },
      { name: 'ArrayElementList', symbols: ['ArrayElement'], postprocess: (d) => [d[0]] },
      {
        name: 'ArrayElementList',
        symbols: ['ArrayElementList', { literal: ',' }],
        postprocess: (d) => [...d[0], null],
      },
      {
        name: 'ArrayElementList',
        symbols: ['ArrayElementList', { literal: ',' }, 'ArrayElement'],
        postprocess: (d) => [...d[0], d[2]],
      },
      ...
      {
        name: 'ArrayLiteralNoFunction',
        symbols: [{ literal: '[' }, { literal: ']' }],
        postprocess: (d) => ({ type: 'ArrayExpression', elements: [] }),
      },
      {
        name: 'ArrayLiteralNoFunction',
        symbols: [{ literal: '[' }, 'ArrayElementListNoFunction', { literal: ']' }],
        postprocess: (d) => ({ type: 'ArrayExpression', elements: d[1] }),
      },
      {
        name: 'ArrayElementListNoFunction',
        symbols: ['ArrayElementNoFunction'],
        postprocess: (d) => [d[0]],
      },
      {
        name: 'ArrayElementListNoFunction',
        symbols: ['ArrayElementListNoFunction', { literal: ',' }],
        postprocess: (d) => [...d[0], null],
      },
      {
        name: 'ArrayElementListNoFunction',
        symbols: ['ArrayElementListNoFunction', { literal: ',' }, 'ArrayElementNoFunction'],
        postprocess: (d) => [...d[0], d[2]],
      },
      {
        name: 'ArrayElementNoFunction',
        symbols: ['AssignmentExpressionNoFunction'],
        postprocess: id,
      },
      {
        name: 'ArrayElementNoFunction',
        symbols: [{ literal: '...' }, 'AssignmentExpressionNoFunction'],
        postprocess: (d) => ({ type: 'SpreadElement', argument: d[1] }),
      },
      {
        name: 'ObjectLiteral',
        symbols: [{ literal: '{' }, 'PropertyList', { literal: '}' }],
        postprocess: (d) => ({ type: 'ObjectExpression', properties: d[1] }),
      },
      { name: 'PropertyList', symbols: [], postprocess: () => [] },
      { name: 'PropertyList', symbols: ['Property'], postprocess: (d) => [d[0]] },
      {
        name: 'PropertyList',
        symbols: ['PropertyList', { literal: ',' }, 'Property'],
        postprocess: (d) => [...d[0], d[2]],
      },
      {
        name: 'Property',
      ...
      {
        name: 'Property',
        symbols: ['PropertyKey', { literal: ':' }, 'AssignmentExpression'],
        postprocess: (d) => ({ type: 'Property', key: d[0], value: d[2], shorthand: false }),
      },
      {
        name: 'Property',
        symbols: [{ literal: '...' }, 'AssignmentExpression'],
      ...
      {
        name: 'ObjectLiteralNoFunction',
        symbols: [{ literal: '{' }, 'PropertyListNoFunction', { literal: '}' }],
        postprocess: (d) => ({ type: 'ObjectExpression', properties: d[1] }),
      },
      { name: 'PropertyListNoFunction', symbols: [], postprocess: () => [] },
      {
        name: 'PropertyListNoFunction',
        symbols: ['PropertyNoFunction'],
        postprocess: (d) => [d[0]],
      },
      {
        name: 'PropertyListNoFunction',
        symbols: ['PropertyListNoFunction', { literal: ',' }, 'PropertyNoFunction'],
        postprocess: (d) => [...d[0], d[2]],
      },
      {
        name: 'PropertyNoFunction',
        symbols: [lexer.has('identifier') ? { type: 'identifier' } : identifier],
        postprocess: (d) => ({
          type: 'Property',
          key: d[0].value,
      ...
      {
        name: 'PropertyNoFunction',
        symbols: ['PropertyKey', { literal: ':' }, 'AssignmentExpressionNoFunction'],
        postprocess: (d) => ({ type: 'Property', key: d[0], value: d[2], shorthand: false }),
      },
      {
        name: 'PropertyNoFunction',
      ...
      },
      {
        name: 'PropertyKey',
        symbols: [lexer.has('string') ? { type: 'string' } : string],
        postprocess: (d) => ({ type: 'Literal', value: d[0].value }),
      },
      {
        name: 'PropertyKey',
        symbols: [{ literal: '[' }, 'Expression', { literal: ']' }],
      ...
      {
        name: 'FunctionExpression$ebnf$1',
        symbols: [],
        postprocess: function (d) {
          return null;
        },
      ...
      {
        name: 'FunctionExpression$ebnf$2',
        symbols: [],
        postprocess: function (d) {
          return null;
        },
      },
      {
        ...
        symbols: [
          'FunctionExpression$ebnf$1',
          { literal: 'function' },
          'FunctionExpression$ebnf$2',
          { literal: '(' },
          'ParameterList',
          { literal: ')' },
          'Block',
      ...
      {
        name: 'ArrowParameters',
        symbols: [{ literal: '(' }, 'ParameterList', { literal: ')' }],
        postprocess: (d) => d[1],
      },
      ...
      { name: 'ArrowBody', symbols: ['AssignmentExpression'], postprocess: (d) => d[0] },
      {
        ...
        postprocess: (d) => ({ type: 'BlockStatement', body: d[1] }),
      },
    ],
    ParserStart: 'Program',
  };
