...
import { WangMetadata, MetadataCollector } from '../../wang-metadata-api.js'
...
describe('Wang Metadata API', () => {
  ...
  describe('Compilation Phase Metadata', () => {
    ...
    it('should track AST nodes and depth', () => {
      const nodes = [
        ...
        { type: 'VariableDeclaration', location: { startLine: 1, startColumn: 0, endLine: 1, endColumn: 10 } },
        { type: 'BinaryExpression', location: { startLine: 1, startColumn: 12, endLine: 1, endColumn: 20 } },
        { type: 'FunctionCall', location: { startLine: 1, startColumn: 28, endLine: 1, endColumn: 35 } },
      ]
    ...
    it('should track parse timing', () => {
      ...
      expect(metadata.compilation.parseEndTime).toBeGreaterThan(metadata.compilation.parseStartTime)
    })
  ...
  describe('Interpretation Phase Metadata', () => {
    it('should track module resolutions', () => {
      ...
      expect(metadata.interpretation.moduleDependencies.get('/src/utils.wang').has('/lib/core.wang')).toBe(true)
    })
    ...
    it('should track symbol definitions', () => {
      ...
      expect(metadata.interpretation.symbols.functions.get('processData').params).toEqual(['data', 'options'])
      expect(metadata.interpretation.symbols.classes.get('DataProcessor').extends).toBe('BaseProcessor')
    })
    ...
    it('should track imports and exports', () => {
      ...
      expect(metadata.interpretation.symbols.exports.get('processData').module).toBe('/src/utils.wang')
    })
  ...
  describe('Execution Phase Metadata', () => {
    ...
    it('should track execution timing', () => {
      ...
      expect(metadata.execution.endTime - metadata.execution.startTime).toBeGreaterThanOrEqual(delay - 1)
    })
  })
  ...
  describe('Runtime Metadata', () => {
    ...
    it('should record events with context', () => {
      const callId = metadata.recordCall('testFunc', [], null)
